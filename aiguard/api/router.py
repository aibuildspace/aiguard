...
def build_dev_router() -> APIRouter:
    ...
    from aiguard.api.endpoints.orgs import router as orgs_router
    from aiguard.api.endpoints.users import router as users_router
    from aiguard.api.endpoints.api_keys import router as keys_router
    from aiguard.api.endpoints.shields import router as shields_router
    from aiguard.api.endpoints.audit import router as audit_router
    from aiguard.api.endpoints.dashboard import router as dashboard_router
    from aiguard.api.endpoints.budgets import router as budgets_router
    from aiguard.api.endpoints.costing import router as costing_router
    from aiguard.api.endpoints.settings import router as settings_router
    from aiguard.api.endpoints.activations import router as activations_router
    from aiguard.api.endpoints.llm_shields import router as llm_shields_router
...
def _read_only_audit() -> APIRouter:
    ...
    from aiguard.api.endpoints.audit import list_audit_logs, get_audit_log, AuditLogResponse
...
def _read_only_budgets() -> APIRouter:
    ...
    from aiguard.api.endpoints.budgets import list_budgets, get_budget, BudgetResponse
...
def _read_only_shields() -> APIRouter:
    from aiguard.api.endpoints.shields import list_shields, get_shield
...
def _read_only_orgs() -> APIRouter:
    from aiguard.api.endpoints.orgs import list_orgs, get_org, OrgResponse
...
def _read_only_users() -> APIRouter:
    from aiguard.api.endpoints.users import list_users, get_user, UserResponse
...
def _read_only_llm_shields() -> APIRouter:
    from aiguard.api.endpoints.llm_shields import list_llm_shields, get_llm_shield
