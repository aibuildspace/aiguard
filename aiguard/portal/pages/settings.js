...
async function renderSettings() {
    ...
    var current = {
        grafana_enabled: false, grafana_otlp_endpoint: "", grafana_otlp_headers: "", grafana_service_name: "aiguard",
    };
    ...
    function _grafanaTraceSection() {
        ...
        return _grafanaFields()
            ...
            +   '<img src="/portal/static/shield256.png" class="activation-logo" alt="AIGuard">'
    ...
    function _grafanaFields() {
        return '<div id="grafana-fields">'
            ...
            + '</div>'
            + '<div class="settings-form-group"><label for="grafana-service">Service Name</label><input type="text" id="grafana-service" placeholder="aiguard" value="' + esc(current.grafana_service_name) + '"></div>'
            + '</div>';
    }
    ...
    +       '<div class="settings-guide-note"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>Every proxied response includes <code>traceparent</code> and <code>X-AIGuard-Trace-ID</code> headers.</span></div>'
    +     '</div>'
    +   '</details>'
    ...
    $("#grafana-save").onclick = async function() {
        ...
        var payload = {
            ...
            grafana_service_name: $("#grafana-service").value.trim() || "aiguard",
